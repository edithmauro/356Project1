...
<h1 style="text-align: center; color: #800000;">Add New Shipping Information</h1>
	
	<?php
	include("includes/openDBconn.php");
	
	$Submit = $_POST['shipAdd'];
	?>
	
	<form id="form0" name="form0" method="post" action="shipAddDo.php">
    	<fieldset id="shipping">
        	<legend>Adding Shipping Information</legend>
        	<ul>
				...
				<li> <label title="Lastname" for="name">Last Name<span>*</span></label> <input type="text" name="lastname" id="lastname" size="30" maxlength="30" /></li>
				...
				<li> <label title="Country" for="country">Country<span>*</span></label> <input type="text" name="country" id="country" size="30" maxlength="9" /></li>
				<li><span><?php echo $_SESSION["errorMessage"]; ?></span></li>
            	<li><button  class = "BTN" id="shipSubmit" name="shipAddDo" type="submit" value='<?php echo($Submit); ?>' formaction="shipAddDo.php">Add Info</button></li>
       		</ul>
